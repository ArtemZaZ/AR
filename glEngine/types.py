...
uniformTypesToFunctions = {
    ...
    gl.GL_FLOAT_VEC2: (gl.glUniform2fv, 1, False),
    gl.GL_FLOAT_VEC3: (gl.glUniform3fv, 1, False),
    gl.GL_FLOAT_VEC4: (gl.glUniform4fv, 1, False),
    ...
    gl.GL_DOUBLE_VEC2: (gl.glUniform2dv, 1, False),
    gl.GL_DOUBLE_VEC3: (gl.glUniform3dv, 1, False),
    gl.GL_DOUBLE_VEC4: (gl.glUniform4dv, 1, False),
    ...
    gl.GL_INT_VEC2: (gl.glUniform2iv, 1, False),
    gl.GL_INT_VEC3: (gl.glUniform3iv, 1, False),
    gl.GL_INT_VEC4: (gl.glUniform4iv, 1, False),
